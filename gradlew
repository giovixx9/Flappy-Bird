...
if [ "$cygwin" = "true" -o "$msys" = "true" ] ; then
    ...
    case $i in
        ...
        (2) set -- "$args1" "$args2" ;;
        (3) set -- "$args1" "$args2" "$args3" ;;
        (4) set -- "$args1" "$args2" "$args3" ;;
        (5) set -- "$args1" "$args2" "$args3" "$args4" ;;
        (6) set -- "$args1" "$args2" "$args3" "$args4" "$args5" ;;
        (7) set -- "$args1" "$args2" "$args3" "$args4" "$args5" "$args6" ;;
        (8) set -- "$args1" "$args2" "$args3" "$args4" "$args5" "$args6" "$args7" ;;
        (9) set -- "$args1" "$args2" "$args3" "$args4" "$args5" "$args6" "$args7" "$args8" ;;
    esac
fi
